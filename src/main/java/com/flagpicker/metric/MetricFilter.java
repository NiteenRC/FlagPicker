...
/**
 * This MetricFilter implementation helps to filter hits per service
 * 
...
public class MetricFilter implements Filter {
	...
	public void init(final FilterConfig config) throws ServletException {
		if (metricService == null || actMetricService == null) {
			...
			actMetricService = WebApplicationContextUtils.getRequiredWebApplicationContext(config.getServletContext())
